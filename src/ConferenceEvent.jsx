...
import { incrementAddOnQuantity, decrementAdOnQuantity } from "./addOnSlice";
...
const ConferenceEvent = () => {
  ...
  const handleDecrementAddOnQuantity = (index) => {
    dispatch(decrementAdOnQuantity(index));
  };

  const handleMealSelection = (index) => {
    const item = mealsItems[index];
    if (item.selected && item.type === "mealForPeople") {
      // Ensure numberOfPeople is set before toggling the meal selection
  ...
  const calculateTotalCost = (section) => {
    let totalCost = 0;
    if (section === "venue") {
      totalCost = venueItems.reduce((acc, item) => acc + item.cost * item.quantity, 0);
    } else if (section === "addons") {
      totalCost = addOnItems.reduce((acc, item) => acc + item.cost * item.quantity, 0);
                  ...
                  <div className="av_data venue_main" key={index}>
                    ...
                    <div className="addons_btn">
                      <button
                        ...
                        onClick={() => handleDecrementAddOnQuantity(index)}
                      >
                        &ndash;
                      </button>
                      ...
                      <button
                        ...
                        onClick={() => handleIncrementAddOnQuantity(index)}
                      >
                        &#43;
                      </button>
                    </div>
